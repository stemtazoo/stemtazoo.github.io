...
description: エンコーダ・デコーダ構造の基本をG検定向けに整理します。入力を特徴表現へ変換するエンコーダと、目的の出力へ戻すデコーダの役割、翻訳や生成モデルでの使いどころを確認できます。本文では、用語の定義、代表例、似た概念との違い、G検定で迷いやすい選択肢の見分け方まで、短時間で復習できるようにまとめています。
