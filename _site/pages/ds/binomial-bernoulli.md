...
description: 二項分布とベルヌーイ試行の関係を整理します。成功・失敗の1回の試行と、独立試行を繰り返した成功回数の確率の違いを押さえ、DS検定で問われる確率分布の基本を確認できます。本文では、用語の定義、具体例、似た概念との違い、試験で迷いやすい選択肢の見分け方まで、短時間で復習できるようにまとめています。
