...
description: データレイクの特徴をDWHとの違いから整理します。構造化・非構造化データをそのまま蓄積する考え方、分析基盤としての使いどころ、DS検定で問われるデータ管理の判断ポイントを確認できます。本文では、用語の定義、具体例、似た概念との違い、試験で迷いやすい選択肢の見分け方まで、短時間で復習できるようにまとめています。
