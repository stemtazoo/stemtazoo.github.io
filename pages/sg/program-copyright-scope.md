...
description: "プログラムの著作権が保護するのは創作的なコードの表現であり、アルゴリズムやプログラミング言語、規約、解法そのものではありません。必要な改変やバックアップが許される範囲と、違法複製物を業務で使用する場合の責任を分け、SG試験の権利範囲を判断します。"
...
また、文化庁の令和2年著作権法改正ページには、改正法の条文、新旧対照表、解説資料などがまとめられています。プログラム関係では、**プログラムの著作物に係る登録制度の整備**も確認できます。

- [文化庁：令和2年通常国会 著作権法改正について](https://www.bunka.go.jp/seisaku/chosakuken/hokaisei/r02_hokaisei/)

SG試験で法令の根拠を確認するときは、**現行法はe-Gov、改正の背景や制度変更は文化庁の公式資料**という使い分けにすると整理しやすいです。
...
具体的なソフトウェア利用場面について補足的に確認したい場合は、著作権情報センター（CRIC）のQ&Aも参考になります。
