...
description: "ウォードライビングは、車などで移動しながら周囲の無線LANアクセスポイントを探し、不正接続やただ乗りの入口にする行為です。SG試験で迷いやすいSEOポイズニング、IDS・IPS、通常のWi-Fi利用との違いを整理します。"
...
ウォードライビングは、街中を車などで移動しながら「鍵のかかりが甘いWi-Fi」や無線LANアクセスポイントを探すような行為です。

たとえば、会社や店舗の近くを車で通りながら、スマートフォンやノートPCで周囲のWi-Fiを調べます。

その中に、暗号化が弱いもの、パスワードが推測しやすいもの、古い設定のまま使われているものがあると、不正アクセス、ただ乗り、通信の盗聴の入口として狙われる可能性があります。
