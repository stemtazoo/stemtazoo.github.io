...
### 平成30年度版の過去問で問われる切り分け

過去問では、平成30年度版の名称で出ても、基本的な判断軸は同じです。

| 問われ方 | 判断 | 理由 |
|---|---|---|
| 情報をCIAの観点で格付けし、取扱いを決める説明 | 正解候補 | 統一基準では、情報の重要度を複数の観点で整理する |
| 個人情報だけを保護する制度として説明している | 不正解候補 | 行政で扱う情報全体の保護を考える基準である |
| 民間企業すべてに直接適用されると説明している | 不正解候補 | 適用範囲を広げすぎている |
| 不正アクセス行為の禁止を中心に説明している | 不正解候補 | 犯罪行為を禁止する法律とは役割が違う |

試験では、**「政府機関等の共通基準」「CIAによる情報の格付」「適用範囲を広げすぎていないか」**の3点で切り分けます。
