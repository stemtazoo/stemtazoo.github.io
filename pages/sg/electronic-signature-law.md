...
SG試験では、電子署名法そのものの条文暗記よりも、**電子署名を業務で安全に使うときに何を確認するか**という視点で整理すると分かりやすくなります。

- 電子署名の対象は、紙ではなく**電磁的記録**である
- 本人による電子署名があると、真正に成立したものと推定される
- 認証業務は、政府だけに限られず、民間事業者も行える
- 電子署名は、共通鍵暗号だけに限定されない

選択肢では、**「電子署名＝単なる電子化された印影」**や、**「認証業務は政府だけが行う」**と書かれていたら注意です。

このSG記事では、FE記事よりも **運用・信頼の仕組み** に寄せて整理します。
...
FEで「条文の内容を選択肢から切る」対策をしたい場合は、[基本情報技術者試験向けの電子署名法解説](/fe/electronic-signature-law/)を参照してください。
...
認証業務そのものは、民間事業者も行うことができます。

そのうち、一定の要件を満たす認証業務は**特定認証業務**とされ、さらに基準を満たす場合には主務大臣の認定を受けることができます。
...
SGではさらに、**認証業務そのもの**と**国の認定を受けた特定認証業務**を混同しないことが大切です。
...
認証業務は、民間事業者も行うことができます。

その中で、一定の要件を満たすものが**特定認証業務**であり、さらに基準を満たす場合に国の認定を受けることができます。
...
- 認証業務は民間事業者も行える
- 一定要件を満たすものが特定認証業務で、基準を満たせば国の認定を受けられる
...
ウは、「政府だけ」と限定している点が誤りです。認証業務は民間事業者も行うことができ、そのうち一定要件を満たすものが特定認証業務です。
