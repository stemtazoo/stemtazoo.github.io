...
| [BEC](/sg/business-email-compromise/) | 経営者や取引先を装い、送金などを指示する詐欺 |

SG試験で選択肢を切るときは、次のように**文面の狙い**を見ます。

| 問われ方 | 分類 | 切り分けポイント |
|---|---|---|
| 受信者の担当業務や取引に関係がありそうな文面で近づく | 標的型攻撃メール | 特定の相手をだますため、業務上ありそうな内容に寄せている |
| 広告・宣伝を主目的として大量送信される | 迷惑メール・広告メール | 標的に合わせた侵入ではなく、不特定多数向けの送信が中心 |
| 存在しない料金や債務を口実に支払いを求める | 架空請求詐欺 | 金銭を振り込ませる詐欺であり、標的型攻撃メールの本質とは異なる |
| 実在するサービスを装った偽サイトへ誘導する | フィッシング | 認証情報を入力させる偽サイト誘導が中心 |

標的型攻撃メールのソーシャルエンジニアリングは、**受信者が「自分の業務に関係ありそう」と思い込む心理**を突く点が特徴です。
...
- 担当業務や取引に合わせた自然な文面なら、ソーシャルエンジニアリングを疑う
