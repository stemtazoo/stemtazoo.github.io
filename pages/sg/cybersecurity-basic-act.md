...
SG試験では、設置機関を入れ替えた選択肢が出ることがあります。

| 選択肢 | 判断 |
|---|---|
| 内閣 | 正しい。サイバーセキュリティ戦略本部を置く機関 |
| 経済産業省 | IPAや産業政策の印象で選ばせるひっかけ |
| 国家安全保障会議 | 「安全保障」という語感で選ばせるひっかけ |
| 国会 | 法律を制定する機関だが、戦略本部を置く機関ではない |

👉 **「サイバーセキュリティ戦略本部はどこに置かれるか」なら、内閣**と覚えます。
