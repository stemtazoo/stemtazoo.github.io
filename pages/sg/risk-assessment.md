...
description: "リスクアセスメントはリスクを特定・分析・評価するプロセスです。JIS Q 31000・31010の考え方や準備段階の重要性、SG試験・情報セキュリティマネジメント試験のひっかけポイントを整理します。"
...
A. 脅威の有無を感覚だけで判断し、記録は残さない。  
B. 資産・脅威・脆弱性・影響等を整理し、リスクの大きさを評価して対応判断につなげる。  
C. 対応策を先に決めてから、後でリスクを作る手順である。  
D. 年1回の形式的チェックだけで十分で、環境変化は考慮しない。  
