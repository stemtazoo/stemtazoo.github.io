---
layout: page
title: "NCOとは？政府のサイバー司令塔を理解する【SG試験】"
description: NCOは、政府全体のサイバーセキュリティ対策を推進・調整する司令塔として位置づけられる組織です。NISC、JPCERT/CC、IPAとの役割の違い、政策調整と現場のインシデント対応を混同しないための判断基準をSG試験向けに整理します。SG試験の出題文で迷いやすい判断ポイントも確認します。
permalink: /sg/nco/
