...
description: "LANアナライザーは、ネットワークを流れるパケットを取得し、通信障害の調査やプロトコル解析に使うツールです。ミラーポートで監視しても通常は通信を中継・遮断しない点と、盗聴に悪用される危険を押さえ、ファイアウォールやIDSとの役割差を判断できます。"
...
## SG試験での判断ポイント
選択肢では、LANアナライザーが**通信を観測・記録・分析する道具か**を確認します。

特に、**「通信を監視・記録して障害解析に使えるが、悪用されると盗聴リスクがある」**という説明は、LANアナライザーの特徴として適切です。
