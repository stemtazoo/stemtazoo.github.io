...
このページは、**内部統制を業務・セキュリティ運用の中でどう機能させるか**を中心に整理します。

- SG：承認、職務分掌、監査、リスク対応を業務運用の判断として考える
- FE：6要素の定義を短い事例から分類し、科目Aの選択肢を切る

FE向けに、経営方針、保険、内部監査、職務分掌などの事例を6要素へ分類する方法を確認したい場合は、[内部統制の6つの基本的要素とは？統制活動の見分け方【基本情報技術者試験】](/fe/internal-control-components/)を参照してください。
