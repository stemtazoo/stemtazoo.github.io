...
description: ポート番号は、通信先のサービスやアプリケーションを識別するための番号です。HTTP、HTTPS、SMTP、DNSなど代表的な番号、ファイアウォール設定で許可・拒否する対象、IPアドレスやプロトコルとの違いをSG試験向けに整理します。SG試験の出題文で迷いやすい判断ポイントも確認します。
