...
description: "データモデルは、業務で扱うデータの構造や関係を整理する考え方です。この記事では概念データモデル、論理データモデル、物理データモデルの違いと、ER図との関係をSG試験・情報セキュリティマネジメント試験向けに整理します。 選択肢で問われる目的・対象・責任範囲を押さえ、似た用語や対策との違いを判断できるようにします。"
