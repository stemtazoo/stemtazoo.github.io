---
layout: page
title: ワークアラウンドとは？暫定対策・恒久対策との違いを整理【SG試験】
description: ワークアラウンドは、問題そのものを直さず、パッチ適用などの恒久対策までの間にリスクを下げる暫定的な回避策です。パッチ・恒久対策・リスク受容との違い、代表例、SG試験での判断基準を整理します。
...
**ワークアラウンドとは、問題そのものを直さず、恒久対策までの間にリスクを下げる暫定的な回避策**です。

SG試験では、次の3つを切り分けます。

| 用語・対応 | 役割 | 判断ポイント |
|---|---|---|
| ワークアラウンド | 暫定的にリスクを下げる | 根本原因は残る |
| パッチ・恒久対策 | 問題や脆弱性そのものを修正する | 根本対策 |
| リスク受容 | リスクを認識した上で受け入れる | 対策を実施しない場合がある |

迷ったら、**「根本原因を直したか」「一時的に回避しているか」「リスクを受け入れているか」**を確認します。
