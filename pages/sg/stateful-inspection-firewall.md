...
- パケットフィルタリングを確認したい → [パケットフィルタリングとは？通信を制御する基本技術【SG試験】](/sg/packet-filtering/)
- ファイアウォールの全体像を確認したい → [ファイアーウォールとは？通信を制御する基本対策【SG試験】](/sg/firewall/)
- アプリ層防御（WAF）を確認したい → [WAFとは？Webアプリを守る仕組みを理解する【SG試験】](/sg/waf/)
