...
layout: page
title: "SG公式過去問"
description: "情報セキュリティマネジメント試験（SG）のIPA公式公開問題を，PDFを見ながら回答・採点・解説確認できるページです。 選択肢で問われる目的・対象・責任範囲を押さえ、似た用語や対策との違いを判断できるようにします。 選択肢で問われる目的・対象・責任範囲を押さえ、似た用語や対策との違いを判断できるようにします。"
permalink: /sg/past/
