...
RSAは、NISTの用語集でも、鍵確立や電子署名の生成・検証に使われる公開鍵アルゴリズムとして説明されています。国内の一次情報としては、IPAのJCMVPで[RSA確認リスト](https://www.ipa.go.jp/security/jcmvp/verified/rsaval.html)が公開されており、RSAを公開鍵暗号として確認できます。また、[CRYPTREC暗号リスト](https://www.cryptrec.go.jp/list.html)でも用途ごとにRSA系方式が整理されています。

共通鍵暗号との違いは、[AES](/sg/aes/)や[公開鍵暗号方式](/sg/public-key-cryptography/)の記事も合わせて確認すると整理しやすくなります。
...
実務では、データ本体はAESなどの共通鍵暗号方式で暗号化し、鍵の受け渡しや認証の部分で公開鍵暗号方式を使う、という組み合わせで考えることがあります。この考え方は[ハイブリッド暗号方式](/sg/hybrid-cryptography/)として整理できます。
