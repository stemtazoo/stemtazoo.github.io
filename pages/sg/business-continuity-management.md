...
description: BCMを、事業中断へ備える方針とBCPを策定し、教育・訓練・点検・見直しを継続して組織の事業継続能力を高めるマネジメント活動として整理します。緊急時の具体的な行動計画であるBCP、業務停止の影響を分析するBIAとの役割を比較し、計画を一度作れば完了、情報システム部門だけの仕事という誤答を避けます。
