...
### 委託先管理の監査で確認するポイント（SG試験）

SG試験では、請負契約の外部委託管理について、**委託元が監督・監査できる状態か**を問う選択肢がよく出ます。

特に、次の観点を確認できることが重要です。

- 受託側要員のアクセス権限が、契約・社内規程どおりに管理されているか
- アクセスログや承認記録など、監査証跡を確認できるか
- 再委託先を含め、同等のセキュリティ管理が実施されているか
- 進捗・品質・事故報告の管理状況を、委託元が継続的に把握できるか

### ひっかけ回避の切り分け

- 「委託元が監査できるように定める」→ 正しい方向
- 「委託元は調査しない」「受託側に一任する」→ 誤り
- 「委託元が受託側要員へ直接指揮命令する」→ 契約責任の切り分けとして不適切
