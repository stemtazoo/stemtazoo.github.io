...
description: JPCERT/CCは国内外の情報セキュリティインシデント対応を調整する組織です。CSIRT、SOC、IPA、NISCとの違いをSG試験の判断基準で整理します。 試験対策として重要語の定義・具体例・よくある誤解をまとめ、短時間で復習できるように整理しています。
...
JPCERT/CCは「インシデントの報告受付・対応支援・分析・調整」が中心です。選択肢に別の公的組織や取組が混ざる場合は、次のキーワードで切り分けます。

| 手掛かり | 疑う対象 | JPCERT/CCとの違い |
|---|---|---|
| JISや産業標準の審議・調査 | JISC | 標準化のための審議が中心で、インシデント対応の調整ではない |
| 暗号技術の評価、電子政府で使う暗号方式 | CRYPTREC | 暗号技術の評価・リスト化が中心で、事故対応の連絡調整ではない |
| 政府全体のサイバー政策や司令塔機能 | NCO / NISC | 政策・統括側の役割であり、実務的なインシデント調整とは異なる |
| インシデントの受付、関係者調整、技術的助言、注意喚起 | JPCERT/CC | 複数組織にまたがる対応支援を示すため、JPCERT/CCが候補になる |

「インシデント対応を進めるために、情報を受け取り、分析し、関係者間を調整する」という文脈なら、JPCERT/CCを選ぶ判断材料になります。
