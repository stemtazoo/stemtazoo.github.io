...
description: BECは、取引先や経営者を装ったメールで送金や情報提供をだますビジネスメール詐欺です。メール爆弾、第三者中継、なりすまし誹謗中傷との違いをSG試験向けに整理します。
...
| 大量メールで相手のメール利用を妨害する | メール爆弾・メールボム系の妨害 |
| 第三者中継が可能なメールサーバをスパム中継に悪用する | 第三者中継・スパム中継の話 |
| 組織のアドレスを詐称して誹謗中傷メールを送る | なりすましによる信用毀損の話 |

👉 判断ポイント：
**金銭をだまし取る業務メール詐欺ならBEC、メール配送の妨害や中継悪用、信用毀損が中心なら別の攻撃**として切ります。
...
- SG試験では「ウイルス対策だけで十分」「緊急なので確認省略」「金銭被害ではないメール妨害」を切る
