...
description: "チャレンジレスポンス認証が現代の一般的なWebサービスで主流になりにくい理由を、秘密情報の同期・専用実装などの運用コスト、利用者体験、TLS普及による平文盗聴対策上の相対的な利点低下から整理します。方式自体が危険だから廃れた、常にMFAより安全、現在も標準的というSG試験の説明を実務の採用条件から検討します。"
