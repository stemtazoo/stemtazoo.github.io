---
layout: page
title: IPsecのESPとは？AHとの違いと暗号化範囲を整理【SG試験】
description: ESPはIPsecで通信内容を暗号化する仕組みです。AHとの違い、トンネルモードとトランスポートモード、どこまで暗号化されるかをSG試験向けに整理します。
permalink: /sg/esp/
...
検索結果で「ESP」だけを見ると別の意味と混同しやすいため、この記事では **IPsecで使うESP** を扱います。

SG試験では、ESPそのものの暗号方式を細かく問うよりも、**「どこが暗号化されるのか」**、**「AHと何が違うのか」**、**「トンネルモードとトランスポートモードで何が違うのか」**を判断させる問題が出やすいです。
