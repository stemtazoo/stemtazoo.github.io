...
同じ監査対象でも、時期によって目的を切り替えることがあります。

- 体制が未整備な段階：助言型監査で問題点を整理し、改善を進める
- 一定水準に達した段階：保証型監査で適切性を評価し、結果を示す

このため、保証型と助言型は**排他的にどちらか一方しか選べない**わけではありません。
ただし、同一時点で目的を混ぜすぎると、監査の独立性や評価の明確性が弱くなるため、監査計画で目的を明確に分けることが重要です。
...
同じ監査対象でも、時期を分けて助言型から保証型へ移ることはあります。
一方で、同一時点で両方の目的を混ぜてしまうと、独立性や客観性が弱くなるおそれがあります。
...
保証業務・助言業務・監査の違いの説明として適切なものはどれか。

- ア. いずれも独立性は不要で、目的も同一である。
- イ. 監査は基準適合性の評価、助言は改善提案が中心である。
- ウ. 助言業務は必ず法定監査報告を伴う。
- エ. 保証業務は証拠収集を行わない。
