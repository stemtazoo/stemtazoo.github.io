...
description: "JISECはIT製品やシステムのセキュリティ機能を第三者が評価・認証する制度です。ISO/IEC 15408との関係やSG試験・情報セキュリティマネジメント試験のひっかけポイントを整理します。"
permalink: /sg/jisec/
...
### ISO/IEC 15408と似た規格番号の切り分け

SG試験では、ISO/IEC 15408を他の規格番号と並べて選ばせる問題があります。

| 規格 | 試験での見方 |
|---|---|
| ISO/IEC 13335 | 情報通信技術セキュリティマネジメントの概念・モデル寄り |
| ISO/IEC 14516 | 電子認証、電子公証、タイムスタンプなど、信頼できる第三者サービス寄り |
| ISO/IEC 15408 | IT製品・システムのセキュリティ機能を評価する基準 |
| ISO/IEC 17799 | 情報セキュリティマネジメントの管理策寄り |

「システム及び製品」「セキュリティ特性」「評価基準」という表現が出たら、ISO/IEC 15408を候補にします。

一方で、「組織の管理策」「セキュリティマネジメント」「運用ルール」が中心なら、ISO/IEC 15408ではなく、ISMSや管理策寄りの規格を疑います。
