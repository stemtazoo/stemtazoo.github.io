...
description: "OP25Bは、動的IPアドレスの利用者回線などから外部メールサーバへ直接向かう25番ポートの通信を遮断し、ボットによるスパム送信を抑える対策です。利用者認証を行うSMTP-AUTHや送信元を検証するSPFとは、制御する通信方向と目的が異なる点を判断できます。"
permalink: /sg/op25b/
...
👉 判断ポイント
OP25Bは、**利用者回線・正規中継を使わない・外向き25番ポート**の組合せで判断します。
