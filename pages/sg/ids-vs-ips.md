...
- IDSの基本を確認したい → [IDSとは？侵入を検知して通知する仕組み【SG試験】](/sg/ids/)
- IPSの基本を確認したい → [IPSとは？不正侵入を検知して遮断する仕組み【SG試験】](/sg/ips/)
- IDS/IPSとFWの違いを確認したい → [ファイアーウォールとは？通信を制御する基本対策【SG試験】](/sg/firewall/)
