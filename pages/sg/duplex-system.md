...
description: "デュプレックスシステムは、一方のコンピュータが稼働し、もう一方が待機して障害時に切り替わる構成です。SG試験で混同しやすいデュアルシステム、ロードシェア、マルチプロセッシングとの違いを整理します。 選択肢で問われる目的・対象・責任範囲を押さえ、似た用語や対策との違いを判断できるようにします。"
