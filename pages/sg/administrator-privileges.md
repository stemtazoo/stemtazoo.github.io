...
IPAの「中小企業の情報セキュリティ対策ガイドライン 第4.0版」では、ユーザーIDと管理者IDについて、**発行・変更・削除の手続きを定め、必要最小限に割り当てること**が示されています。また、共有IDはなるべく使わず、やむを得ず使う場合も利用者を特定できる仕組みを整えることが推奨されています。

個人情報保護委員会のガイドラインでも、管理者権限を持つ利用者であっても、業務上不要なら個人データへ直接アクセスできないよう制御する例が示されています。

SG試験では、**「管理者だから何でもできてよい」ではなく、「管理者であっても必要最小限」**と考えると切り分けやすくなります。
...
- [個人情報保護委員会「特定個人情報の適正な取扱いに関するガイドライン（行政機関等編）」](https://www.ppc.go.jp/legal/policy/my_number_guideline_gyosei/)
