...
このページは、**プロジェクトでのリスクマネジメント（発生前の備え）**を中心に整理します。

- リスクマネジメント：起きる前に洗い出し・評価・対応準備する
- インシデント対応：起きた後に被害拡大を防ぎ復旧する
- 課題管理：すでに顕在化した問題を管理する

> 迷ったら、**「まだ起きていない問題か、すでに起きた問題か」**を見ます。

## SG試験で選択肢を切る判断軸（リスクマネジメント編）

- 「発生可能性×影響度で優先順位を決める」と出る  
  → リスクマネジメントの話

- 「問題発生後の初動封じ込め」と書かれている  
  → インシデント対応の話
...
- リスク対応の流れを確認したい → [リスク対応の全体像とは？評価後に対処方針を決める流れ【SG試験】](/sg/risk-response/)
- 回避・低減・移転・受容の4分類を確認したい → [リスク対応とは？基本概念と4つの分類を整理【SG試験】](/sg/risk-treatment/)
- インシデント発生後の対応を確認したい → [インシデント対応とは？初動対応の判断基準を整理【SG試験】](/sg/incident-response/)
