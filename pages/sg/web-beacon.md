...
description: "Webビーコンは、Webページやメールに埋め込まれる小さな画像などを使って、閲覧状況や利用環境を把握する仕組みです。Cookieやアクセス解析との違い、SG試験での判断ポイントを整理します。 選択肢で問われる目的・対象・責任範囲を押さえ、似た用語や対策との違いを判断できるようにします。"
