...
ア. 利用者に見えない、または誤認しやすい形でボタンなどをクリックさせる攻撃である。  
イ. パスワード候補を総当たりで試す攻撃である。  
ウ. DNSの情報を書き換えて偽サイトへ誘導する攻撃である。  
エ. ファイルパスを操作して想定外のファイルを読ませる攻撃である。  
...
### 解説
- ア：利用者のクリック操作をだまして誘導する点が本質です。
- イ：これはブルートフォース攻撃です。
- ウ：これはDNSキャッシュポイズニングなどで狙われる内容です。
- エ：これはディレクトリトラバーサルです。

👉 判断ポイント
クリックジャッキングは「見た目と実際のクリック先がずれる」攻撃で判断する。
