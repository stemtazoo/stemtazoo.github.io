...
SG試験では、**誰を保護し、誰が責任を負うのか**を切り分ける問題もあります。

| 立場 | 製造物責任法での扱い |
|---|---|
| 消費者・欠陥による被害者 | 保護・救済される側 |
| メーカー・製造業者 | 責任を負う可能性がある側 |
| 輸入業者 | 製造業者等として責任を負う可能性がある側 |
| 通常の小売業者 | 単に販売しただけなら、原則として製造業者等ではない |

試験で「保護の対象」を問われた場合は、**消費者・被害者**を選びます。

ただし、法律上の保護は、商品を購入した本人だけに限られません。購入者でなくても、欠陥製品によって被害を受けた第三者が対象になる場合があります。

したがって、より正確には、

> **消費者を含む、欠陥製品によって被害を受けた人を保護する法律**
...
メーカーや輸入業者は、欠陥による被害が発生した場合に**責任を負う可能性がある側**です。
...
また、通常の小売業者は、単に販売しただけなら原則として製造業者等ではありません。ただし、自社名やブランド名を表示して製造業者のように見せた場合などは、責任を負う側に含まれる可能性があります。
...
### 判断ポイント4：守られる側か、責任を負う側か

人物や事業者の立場を問われたら、次のように切り分けます。
...
## SG試験で選択肢を切る判断軸（ソフトウェア・データ編）

- 「ソフトウェア単体（CD-ROMのアプリ、ダウンロードデータ）」と書かれている  
  → **原則は対象外**。無体物そのものは、PL法の「製造または加工された動産」に当たりません。

- 「欠陥ソフトを内蔵した機器（組込み機器）」と書かれている  
  → **対象になり得る**。欠陥部品を含むハードウェア製品の安全性問題として扱います。

- 「製品それ自体が壊れただけ」と書かれている  
  → **PL法より民法側を疑う**。生命・身体・他の財産への被害があるかを先に確認します。

迷ったら、**「無体物そのものか／欠陥を含む動産として提供されたか」**を先に見ます。

## まとめ（試験直前用）

製造物責任法は、**欠陥製品による被害者を保護するための法律**です。

試験直前は、次の4点を押さえておきましょう。

- **欠陥製品でけが・火災・財産被害** → 製造物責任法
- **消費者・被害者は保護される側、メーカー・輸入業者は責任を負う側**
- **過失ではなく、製品の欠陥に注目する**
