...
description: "パブリックドメインソフトウェアは、著作権が消滅するなどして誰でも自由に利用できる状態のソフトウェアです。シェアウェア、パッケージソフトウェア、ユーティリティソフトウェアとの違いをSG試験向けに整理します。 選択肢で問われる目的・対象・責任範囲を押さえ、似た用語や対策との違いを判断できるようにします。"
