...
description: "契約不適合責任は、納品物が契約内容に合わない場合の責任です。旧用語の瑕疵担保責任、無償修補、善管注意義務や損害賠償との違いをSG試験向けに整理します。"
...
ソフトウェア開発を外部業者に委託する場合、契約書では「納品後、一定期間内に見つかった不具合を無償で修補する」といった責任範囲を明確にします。
...
| 選択肢の内容 | 判断 |
|---|---|
| 瑕疵担保責任 | 過去問の旧用語として、納品物の不具合を無償修補する根拠になり得る |
| 契約不適合責任 | 現在の用語として、契約内容に合わない成果物への責任 |
| 善管注意義務 | 準委任契約などで、注意して業務を行う義務の話 |
| 損害賠償責任 | 金銭的に損害を補う責任で、無償修補そのものの項目とは別 |
| 秘密保持義務 | 情報を漏らさない義務で、不具合修補の根拠とは別 |

👉 判断ポイント：
**納品後一定期間内の不具合を無償で直す根拠を問うなら、旧用語では瑕疵担保責任、現在の整理では契約不適合責任を疑います。**
