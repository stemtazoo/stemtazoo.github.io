...
description: ITガバナンスを「経営目標を達成するためにITを統制し、業務とシステムを全体最適化する考え方」として整理し、コンプライアンスやITマネジメントとの違いをFE試験向けに解説します。
...
ITガバナンスは、コンプライアンスやITマネジメントと混同しやすいです。
