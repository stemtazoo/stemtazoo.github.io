...
このページでは、**フル・差分・増分の違いとバックアップ運用**を中心に扱います。バックアップと冗長化の目的の違いは[バックアップと冗長化の違い](/fe/backup-redundancy/)、外部保管時の安全管理は[バックアップ媒体の外部保管](/fe/backup-media-offsite-storage/)で確認できます。
