...
このページでは、**作業を分解して管理可能な単位にするところまで**を中心に扱います。分解した作業の順序と所要時間から日程を求める場合は[クリティカルパス](/fe/critical-path/)、工程別の重みから全体進捗率を求める場合は[工程別工数配分から進捗率を求める方法](/fe/project-progress-weighted-effort/)を参照してください。
...
プロジェクトマネジメントの国際規格として **ISO 21502:2020** があります。プロジェクトの作業範囲を管理可能な単位へ整理する考え方を確認する際の標準資料として利用できます。
...
FE試験では規格本文の用語を丸暗記するより、**作業を階層的に分解する → WBS** という判断を優先します。
