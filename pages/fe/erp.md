...
| リテールサポート | 小売店の経営・販売活動 | メーカー・卸、小売店支援 |

FE試験では、**企業全体の経営資源を統合して管理する** とあれば、**ERP**を選びます。

このページでは、**企業全体の経営資源と基幹業務を統合するERP**を中心に扱います。営業活動・商談管理に対象を絞る場合は、[SFAとは？](/fe/sfa/) を参照してください。
...
| メーカー・卸売業者が小売店の経営・販売活動を支援する | リテールサポート |
...
試験では、**全社の経営資源ならERP、業務プロセスの抜本的見直しならBPR、営業ならSFA、顧客ならCRM、供給の流れならSCM、ネット取引ならEC、メーカー・卸による小売店支援ならリテールサポート** と切り分けると安全です。
...
- メーカー・卸が小売店の経営・販売活動を支援するならリテールサポート
