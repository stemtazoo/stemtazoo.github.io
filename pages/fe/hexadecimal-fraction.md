...
このページでは、**16進小数の桁の重みと分数の意味**を中心に扱います。16進数を2進数へ直して効率よく変換する手順は、[16進小数の変換とは？](/fe/hexadecimal-fraction-conversion/) で整理しています。 2倍・4倍・8倍などの計算は、[16進小数を2のべき乗倍する方法](/fe/hexadecimal-fraction-bit-shift/) で整理しています。
