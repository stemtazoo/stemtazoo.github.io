...
このページは、**経営目標とIT活用方針をつなぐシステム戦略の入口記事**です。業務・データ・アプリケーション・技術基盤を全体最適で整理する場合は[エンタープライズアーキテクチャ](/fe/enterprise-architecture/)、経営目標に合わせてITを統制する場合は[ITガバナンス](/fe/it-governance/)を参照してください。
