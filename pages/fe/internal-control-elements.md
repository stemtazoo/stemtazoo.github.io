...
### 実施・承認が同じ人になっていないかを見る

システム運用や内部統制の問題では、作業内容そのものだけでなく、**誰が実施し、誰が承認・確認しているか**を見ることが重要です。
...
のように、実施者と確認者が分かれていれば、相互チェックが働きます。

試験では、次の役割が一人に集中していないかを確認します。
...
「記録があるか」だけではなく、**権限や役割が適切に分かれているか**を見るのがポイントです。
...
- **実施者と承認者が同じなら、職務分掌・相互牽制の不足を疑う**
- **記録・保管そのものより、「誰が作成・承認・実行・確認しているか」を見る**
