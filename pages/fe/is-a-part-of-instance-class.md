...
このページは、**is-a・part-of・インスタンスとクラスの関係を比較して見分ける記事**です。クラスとインスタンスの基本だけを先に確認したい場合は、[クラスとインスタンスとは？](/fe/class-instance/) を参照してください。
...
オブジェクト指向では、この関係が**基底クラス（上位クラス）と派生クラス（下位クラス）の継承関係**につながります。
...
問題文に「基底クラス」「派生クラス」と出たら、まず次の一文に置き換えます。
...
- 基底クラスは上位クラス、派生クラスは下位クラス
- 派生クラスは基底クラスの一種と考えられる
