...
さらに、**問題文の「何に対する何の割合か」**を見ると、より確実に切り分けられます。
...
### 「購入者数が増えた」と「コンバージョン率が上がった」は同じ？

同じではありません。

```text
変更前：1,000人訪問 → 20人購入 = 2%
変更後：2,000人訪問 → 30人購入 = 1.5%
```

購入者数は増えていますが、訪問者に対する購入者の割合は下がっています。

画面デザインなどの変更で**「訪問者のうち購入に至る割合」が改善したか**を確認したい場合は、購入者数やページビューだけでなくコンバージョン率を比較します。
...
- ページビューはページの表示回数
- アクセス数とコンバージョン率は別の指標
- 「何に対する何の割合か」を見れば、ROAS・CTR・CVRを切り分けやすい
