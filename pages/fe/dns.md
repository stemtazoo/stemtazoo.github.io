...
ARP・RARP・NATとの違いを一度に整理したい場合は、[ARP・RARP・DNS・NATの見分け方](/fe/arp-rarp-dns-nat/) を参照してください。
...
DNSで混同しやすいのは、DHCP、NAT、ARPです。

詳しい横比較は[ARP・RARP・DNS・NATの見分け方](/fe/arp-rarp-dns-nat/)にまとめています。このページでは、DNS特有の**名前解決**を中心に確認します。
