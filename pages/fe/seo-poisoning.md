...
このページでは、**検索順位を悪用して不正サイトへ誘導する攻撃**としてのSEOポイズニングを扱います。本来のSEO施策は、[SEOとは？](/fe/seo/) で整理しています。
...
IPAの「コンピュータウイルス・不正アクセスの届出事例［2021年上半期］」でも、**SEOポイズニングによる悪性サイトへの誘導**に関する情報が複数寄せられたことが報告されています。

また、国家サイバー統括室（旧NISC）のコラムでは、偽ショッピングサイトへの誘導手口として、**SEO対策を悪用して偽サイトへのURLを検索結果の上位に表示させるSEOポイズニング**が紹介されています。
...
「偽サイトへ誘導」のような**結果**だけで決めず、攻撃の**入口**を見るのがコツです。
