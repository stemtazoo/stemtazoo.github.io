...
ROIそのものが科目Bの中心になることは多くありませんが、投資判断やシステム導入効果を説明する文章で使われる可能性があります。
...
特に、問題文で「割引率は考慮しない」とある場合は、各年の利益をそのまま合計します。

一方、将来のお金の価値を考慮する場合は、ROIではなくNPVなどの別の指標が使われることがあります。
