...
description: デッドロックは、複数のトランザクションやプロセスが資源を保持したまま、互いに相手の資源解放を待ち続けて処理できない状態です。相互排他・保持待ち・横取り不可・循環待ちという成立条件を整理し、いずれかを崩す予防、ロック順序の統一、タイムアウトによる対策を確認します。通常のロック待ちとの違いからFE試験の事例を判断します。
