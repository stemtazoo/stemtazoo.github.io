...
description: 定期発注方式・定量発注方式・二棚法を「発注時期が一定か、発注量が一定か」という判断軸で整理し、発注点の計算や経済的発注量との違いも初心者向けに解説します。
...
発注点とは、**在庫が何個まで減ったら発注するかを決める基準**です。
...
- 発注点は `1日の平均消費量 × 調達期間 + 安全在庫`
- 発注点は「いつ発注するか」、経済的発注量は「何個発注するか」
