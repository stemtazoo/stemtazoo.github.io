...
シャドーITとは、**組織の承認や管理の外で、端末・ソフトウェア・クラウドサービスなどを業務利用すること**です。

BYODとシャドーITは、どちらも個人の端末やサービスが関係することがあるため混同しやすいですが、判断ポイントは**組織が承認・管理しているか**です。

| 用語 | 判断ポイント |
|---|---|
| BYOD | 個人所有の端末を、組織のルールや管理の下で業務利用する |
| シャドーIT | 組織が承認・把握していないITを勝手に業務利用する |
...
つまり、**「私物だからシャドーIT」ではありません。**

試験では、「情報システム部門の許可を得ずに利用」「会社が把握していないクラウドサービスを利用」といった表現があれば、シャドーITを疑います。

IPAの資料でも、組織の承認を得ずに外部サービスを利用することをシャドーITとし、申請・承認の運用が対策として示されています。

- [IPA：基本対策事項 4.2.1(1)-2 b)「外部サービスの名称」について](https://www.ipa.go.jp/security/vuln/scap/ug65p9000001994c-att/guider3_2.pdf)
- [IPA：IoT機器が「シャドーIT」化している](https://www.ipa.go.jp/security/economics/practices_navi/practice305.html)

Microsoftの解説も、BYODとシャドーITの違いや、未承認のクラウドサービス・端末によるリスクを具体例で確認する補助資料として使えます。

- [Microsoft：シャドー IT とは? セキュリティ リスクと防止策について解説](https://www.microsoft.com/ja-jp/area/biz/smb/column-shadow-it)

なお、Microsoftの記事は一般概念の公的な一次情報ではありません。**定義や試験上の根拠はIPAを優先し、Microsoftは具体例や対策の理解を補う参考資料**として使うのが適切です。
...
| 用語 | 見るポイント |
|---|---|
| BYOD | 個人所有の端末を業務に使う。組織の承認・管理下で運用する |
| シャドーIT | 組織の承認・把握外でITを業務利用する |
...
- シャドーITは、組織の承認・把握外で端末・アプリ・クラウドなどを業務利用すること
- **個人端末 + 承認済みならBYOD、未承認利用ならシャドーIT**
