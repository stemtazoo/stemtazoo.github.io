...
特に **「アクタ」「相互作用」「システムが提供する機能」** がそろっていれば、ユースケース図を強く疑います。
...
説明文だけの4択では、次のように置き換えると切りやすくなります。
...
UMLの標準化団体であるOMG（Object Management Group）は、UMLの公式仕様を公開しています。
...
OMGの公式仕様では、UML 2.5.1の中に **Use Cases** の章があり、アクタ（Actor）とユースケース（UseCase）が正式なUML要素として定義されています。

FE試験対策では仕様書の細部まで読む必要はありませんが、次の対応が公式仕様に基づく理解だと押さえておくと安心です。
...
また、UMLはISO/IEC 19505として国際規格化されています。

- [ISO：ISO/IEC 19505-2:2012](https://www.iso.org/standard/52854.html)
