...
科目Aでは、**「どの段階で作られる成果物か」**を問う形でも出題されます。

情報戦略の段階では、経営戦略との整合性を取りながら、組織全体としてどのように情報化を進めるかを整理します。ここで重要なのが**全体最適化計画**です。
...
一方、個別システムをどう作るか、どう運用するかという話になると、より後の段階の成果物です。
...
試験では、選択肢の途中に「全体最適化」という言葉があっても、**最後に示されている成果物が何か**まで確認します。
...
> **単語だけで選ばず、「どの段階で、何を成果物として作るか」で切る。**
...
選択肢の説明中に「全体最適化」という言葉があっても、最終的な成果物が「開発計画」などであれば、情報戦略策定段階の全体最適化計画とは切り分けます。

試験では、**キーワードだけでなく成果物名まで読む**ことが大切です。
...
- 情報戦略の成果物として**全体最適化計画**を押さえる
- 期間・工数・費用ならシステム化計画
- HW・SW・ネットワーク構成ならシステム方式設計
- 「全体」「業務」「情報」「あるべき姿」が重要キーワード
- 「全体最適化」という単語だけでなく、**成果物名まで確認する**
