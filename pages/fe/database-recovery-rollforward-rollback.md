...
このページは、**媒体障害からの回復手順全体**を中心に扱います。更新前ログ・更新後ログの使い分けを詳しく確認したい場合は、[ロールバックとロールフォワードとは？](/fe/rollback-rollforward/) を参照してください。

バックアップ方式や取得間隔まで含めた運用全体は、[データベースのバックアップと復旧](/fe/database-backup-recovery/)で確認できます。
