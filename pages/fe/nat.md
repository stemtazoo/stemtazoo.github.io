...
科目Aでは、**IPアドレスを別のIPアドレスへ変換しているか** を見ます。
...
ARP・DNSなどとの横比較は、[ARP・RARP・DNS・NATの見分け方](/fe/arp-rarp-dns-nat/) で整理しています。
...
複数端末で一つのグローバルIPアドレスを共有する仕組みまで詳しく確認したい場合は、[NAPTとは？NATとの違いとIPマスカレードの仕組み](/fe/nat-napt/) を参照してください。

## よくある誤解・混同

NATで混同しやすいのは、DNS、DHCP、NAPTです。

ARP・DNS・NATの違いは[ARP・RARP・DNS・NATの見分け方](/fe/arp-rarp-dns-nat/)、NATとNAPTの違いは[NAPTとは？NATとの違い](/fe/nat-napt/)に分けて整理しています。
