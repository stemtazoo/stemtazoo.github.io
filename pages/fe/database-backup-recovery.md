...
このページでは、**バックアップの取り方と、バックアップから復旧する全体像**を中心に扱います。トランザクションログの更新前・更新後情報やチェックポイントは[データベースのログファイル](/fe/database-log-recovery/)、媒体障害時のリストア→ロールフォワード手順は[データベースのロールフォワードとロールバック](/fe/database-recovery-rollforward-rollback/)で詳しく確認できます。
