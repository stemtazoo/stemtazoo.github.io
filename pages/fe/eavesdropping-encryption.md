---
layout: page
title: 盗聴対策とは？通信の暗号化とアクセス制御の違いを整理【基本情報技術者試験】
...
科目Aでは、問題文が「何を防ぎたいか」で対策を切り分けます。

| 守りたいこと | 選ぶ対策 |
|---|---|
| 通信経路上で内容を読ませない | 通信の暗号化 |
| 接続元を制限する | IPアドレス制限 |
| 利用者本人か確認する | パスワードなどによる認証 |

ポート番号の変更は接続先を見つけにくくする補助にはなりますが、通信内容を読めなくする仕組みではありません。したがって、盗聴対策を問う選択肢では暗号化を選びます。
