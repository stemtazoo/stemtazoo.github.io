...
このページは、**インシデント管理と問題管理を試験で見分けるための比較記事**です。問題管理の根本原因分析・既知の誤り・恒久対策を詳しく確認したい場合は、[問題管理とは？](/fe/problem-management/) を参照してください。 受付後の記録・分類・優先度設定は、[インシデント及びサービス要求管理](/fe/incident-service-request-management/) で整理しています。
