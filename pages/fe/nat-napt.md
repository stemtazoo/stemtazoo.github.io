...
NATそのものの仕組みは、[NATとは？](/fe/nat/) で詳しく整理しています。このページでは、NAPT特有の**ポート番号を使った多対1の変換**を中心に説明します。
...
科目Aでは、**複数端末・一つのグローバルIPアドレス・ポート番号**が判断の合図です。
...
DNSやDHCPなど他のネットワーク用語との比較は、それぞれの個別記事や[ARP・RARP・DNS・NATの見分け方](/fe/arp-rarp-dns-nat/)で確認できます。
