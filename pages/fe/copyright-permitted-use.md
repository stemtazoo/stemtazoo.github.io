...
文化庁の改正ページには、改正法の条文、新旧対照表、説明資料などがまとめられているため、制度改正の一次情報を確認する入口として使えます。
...
ソフトウェアの複製・インストール・利用許諾など、具体的な利用場面については、著作権情報センター（CRIC）のQ&Aも理解の補助として使えます。

- [CRIC：コンピュータ・ソフトウェアに関するQ&A](https://www.cric.or.jp/qa/shigoto/sigoto10_qa.html)

ただし、**最新の法的根拠を確認するときは、e-Govや文化庁などの一次情報を優先**します。
