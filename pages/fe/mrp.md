...
MRPは、BTO・かんばん方式・コンカレントエンジニアリングと並べて出ることがあります。

| 表現 | 判断する用語 |
|---|---|
| 顧客の注文を受けてから製品を生産する | BTO・受注生産 |
| 作業指示票などで作業や運搬を指示する | かんばん方式 |
| 開発・設計・生産準備などを並行して進める | コンカレントエンジニアリング |
| 基準生産計画を基に部品の所要量を計算する | MRP |

試験中は、次の4語で切ると判断しやすいです。
...
MRPの決め手は、**完成品の生産計画から必要な部品量を逆算すること**です。
...
- 注文後に作るならBTO、作業票ならかんばん、工程並行ならコンカレントエンジニアリング
