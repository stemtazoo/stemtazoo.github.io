...
このページでは、**受付後の記録・分類・優先度・段階的取扱い**を中心に扱います。サービスを早く復旧する活動と根本原因を除く活動の違いは、[インシデント管理と問題管理の違い](/fe/incident-management-vs-problem-management/) を参照してください。
...
**受付後はまず記録し、その後に分類・優先度の設定・段階的取扱いを行う**と判断します。
