...
科目Aでは、問題文の中心が企業の「能力」「比較」「事業領域」「経営の監督」のどれかを見分けます。
...
- 「優良企業との比較から改善点を探す」なら、[ベンチマーキング](/fe/benchmarking/)
...
**他社を参考にするのが[ベンチマーキング](/fe/benchmarking/)、他社にまねされにくい強みを活かすのがコアコンピタンス**です。
...
- 社内の知識共有ならナレッジマネジメント
- 階層を減らすならフラット型組織
- 他社との比較なら[ベンチマーキング](/fe/benchmarking/)
- 事業領域なら事業ドメイン
