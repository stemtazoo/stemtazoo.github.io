...
このページでは、**出来高率と投入工数から最終工数・超過工数を推定する問題**を中心に扱います。人月・生産性・要員数から期間を求める問題は、[人月・生産性・要員数から開発期間を求める方法](/fe/effort-productivity-duration/) を参照してください。
...
工程ごとの工数配分と工程内の完成割合から、**現時点のプロジェクト全体の進捗率**を求めたい場合は、[工程別の工数配分からプロジェクト全体の進捗率を求める方法](/fe/project-progress-weighted-effort/)で整理しています。

見積工数と要員数から工程期間を求める問題は、[人月・生産性・要員数から開発期間を求める方法](/fe/effort-productivity-duration/)で整理しています。
...
また、工程別の工数配分から現時点の全体進捗率を求める問題では、完了工程と進行中工程を重み付きで加算します。
...
- 工程別配分から現時点の全体進捗を求める問題とは計算方法を分ける
