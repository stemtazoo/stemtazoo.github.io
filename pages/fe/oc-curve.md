...
今回のように、**ある不良率のロットがどれだけの確率で合格するか** を知るものを聞かれたら、OC曲線を選びます。
...
| 選択肢 | 判断 |
|---|---|
| OC曲線 | 抜取り検査で、不良率と合格確率を見る。正しい |
| ゴンペルツ曲線 | ソフトウェアテストや信頼度成長の文脈 |
| バスタブ曲線 | 機器の故障率の時間変化の文脈 |
| ロジスティック曲線 | 普及率や成長のS字カーブの文脈 |
