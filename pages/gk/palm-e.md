...
description: "PaLM-Eは言語モデルに視覚・ロボット状態などの連続入力を統合し、現実世界のタスクに対応するためのマルチモーダルモデルです。VLMとの違い、エンボディドAIでの役割、G検定での重要ポイントを整理します。 AI・機械学習での位置づけ、関連モデルや手法との違い、G検定で混同しやすい判断軸を確認できます。"
permalink: /gk/palm-e/
