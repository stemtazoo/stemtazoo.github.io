...
description: "* ネオコグニトロン（Neocognitron）とは、画像認識のために提案された階層型ニューラルネットワークで、現在のCNN（畳み込みニューラルネットワーク）の原型とされるモデルである。 AI・機械学習での位置づけ、関連モデルや手法との違い、G検定で混同しやすい判断軸を確認できます。"
