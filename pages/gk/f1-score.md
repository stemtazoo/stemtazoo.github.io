...
layout: page
title: F1-score
description: "F1-scoreは、PrecisionとRecallの調和平均により、誤検知と見逃しのバランスを1つの値で評価する分類指標です。どちらか一方だけが高くてもF1は高くなりにくい性質と、クラス不均衡でAccuracyより有用になりやすい場面を確認し、単純平均や真陰性を直接含む式だとする誤りを見抜きます。"
