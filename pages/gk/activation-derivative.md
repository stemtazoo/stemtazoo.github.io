...
description: "活性化関数の微分を、誤差逆伝播で勾配を前の層へ伝えるための要素として整理します。シグモイドの微分が出力yを使ってy(1−y)、tanhが1−y²と表せる点と、飽和領域で微分値が小さくなり勾配消失を招く点を押さえ、G検定の式の入替えを見抜きます。"
...
* ReLUの微分は 0 または 1
* ただし、**tanhやシグモイドの微分を問う文脈では、ReLUの微分値と混同しない**
