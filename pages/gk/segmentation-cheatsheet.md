...
description: "FCNは全結合層を置き換えて画素単位の予測を行い、U-Netはエンコーダ側の特徴マップをスキップ接続で渡し、SegNetはプーリング位置を復元に使います。3モデルに共通する用途と、構造上の違いを整理します。"
...
👉 **U-Netは特徴マップ、SegNetはプーリング位置**という違いに注目します。FCNは全結合層を畳み込みへ置き換える全体像で整理します。
