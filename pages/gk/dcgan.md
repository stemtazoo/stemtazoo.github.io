...
description: "* DCGANはGANにCNNを導入した画像生成モデル* Generator / Discriminator の両方に畳み込みを使用* 従来GANより高品質な画像生成が可能G検定ではGAN + CNN」＝ DCGAN と即。 AI・機械学習での位置づけ、関連モデルや手法との違い、G検定で混同しやすい判断軸を確認できます。"
permalink: /gk/dcgan/
