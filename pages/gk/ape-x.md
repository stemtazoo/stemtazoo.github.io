...
description: "APE-Xは、多数のActorが並列に経験を集め、優先度付き経験再生を使ってLearnerが行動価値関数を学ぶ分散・オフポリシー型の深層強化学習手法です。大量の試行と重要な経験の重点学習を組み合わせる役割を捉え、Attention、教師あり学習、時系列モデルという誤説明を切り分けます。"
permalink: /gk/ape-x/
