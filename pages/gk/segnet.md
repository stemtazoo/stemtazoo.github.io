...
description: "SegNet は「セマンティックセグメンテーション向けのエンコーダ・デコーダ型 CNN」で、エンコーダ側で行った最大値プーリングの“位置情報”を記憶し、デコーダでのアップサンプリングに利用するのが最大の特徴です。 AI・機械学習での位置づけ、関連モデルや手法との違い、G検定で混同しやすい判断軸を確認できます。"
permalink: /gk/segnet/
