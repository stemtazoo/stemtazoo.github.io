...
description: "PPOは、方策を直接最適化しつつ、クリッピングによって新旧方策の変化が大きくなりすぎないよう制限する方策勾配法です。急激な更新による性能崩壊を防ぎ、比較的単純な実装で学習を安定させる狙いを確認し、行動価値関数を直接更新するQ学習や、ランダム行動を選ぶ探索戦略との違いを見抜きます。"
permalink: /gk/ppo/
