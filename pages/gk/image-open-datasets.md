...
description: "MNISTは手書き数字、CIFAR-10は小さなカラー画像、Pascal VOCは物体認識のデータセットとして整理します。質問応答のSQuADと比較し、画像か文章かだけでなく、分類・検出・質問応答のどのタスクで使うかを見分けます。"
...
**SQuAD** は質問応答の文章データです。名前だけで画像データと決めないようにします。
...
より広く学ぶなら、画像分類のImageNetや物体検出のCOCOも比較すると整理しやすくなります。
