...
description: オッカムの剃刀は、複数の仮説が同程度に事象を説明できるなら、不要な仮定が少ない単純な方を選ぶという原則です。機械学習で複雑すぎるモデルの過学習を避け、解釈しやすさを保つ考え方に結び付けます。ただし単純なら必ず高精度という法則ではありません。ノーフリーランチ定理など類似する選択肢との違いを整理します。
