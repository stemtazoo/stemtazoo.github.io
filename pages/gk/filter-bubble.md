...
description: "フィルターバブルは、検索・推薦サービスが閲覧履歴や反応を基に表示を個人最適化し、利用者が似た情報ばかりに囲まれる現象です。便利な推薦の副作用として異なる視点へ触れにくくなる仕組みを押さえ、人同士の同調と反復で意見が強化されるエコーチェンバーと比較します。G検定では情報を選別する主体から切り分けます。"
