...
description: "バイアスとバリアンスはトレードオフの関係にあり、G検定では「バイアスが大きいとアンダーフィッティング」「バリアンスが大きいとオーバーフィッティング」と正しく対応づけられるかが問われる。 AI・機械学習での位置づけ、関連モデルや手法との違い、G検定で混同しやすい判断軸を確認できます。"
