...
description: "データリーケージは、学習データに本来使えない未来情報や目的変数に近い情報が混入し、評価が過大になる問題です。訓練・検証データの分割、前処理の順序、カンニング特徴量との関係、時系列データや特徴量作成で起きる典型例、リークを防ぐ検証設計をG検定向けに整理します。"
...
## G検定ひっかけポイント
G検定では、**未来情報や答えに近い情報の混入を見抜くこと**が重要です。
