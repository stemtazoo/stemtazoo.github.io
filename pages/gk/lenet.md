...
layout: page
title: LeNetとは？【G検定対策】
description: "LeNetは、Yann LeCunらが手書き数字認識に用いた、畳み込み層とプーリング層を備える初期のCNNです。小規模画像から局所特徴を抽出する現代CNNの基礎を示した役割を確認し、2012年のImageNetで注目されたAlexNetよりはるか以前のモデルであり、自然言語処理用ではないと判断します。"
permalink: /gk/lenet/
