---
layout: page
title: DDLとDMLの違いとは？CREATE・SELECT・DELETEを一覧で整理【DS検定】
description: DDLはテーブルなどの構造を定義し、DMLはテーブル内のデータを操作するSQLです。CREATE・ALTER・DROPとSELECT・INSERT・UPDATE・DELETEを一覧で比較し、DELETEとDROP、SELECTの扱いをDS検定の判断基準で整理します。
