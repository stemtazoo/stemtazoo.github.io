...
description: "電子署名を、送信者本人が作成したことと文書が改ざんされていないことを確認する仕組みとして整理します。秘密鍵で署名し公開鍵で検証する流れをDS検定向けに確認します。"
...
このページでは、電子署名を「本人性」と「完全性」を確認する仕組みとして整理します。暗号化との違いは、鍵を何の目的で使うかに注目して切り分けます。

DS検定では、「秘密鍵で署名し、公開鍵で検証する」流れを正しく判断できるかが問われます。
