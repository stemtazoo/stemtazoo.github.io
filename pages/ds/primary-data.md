...
description: "一次データとは、調査・観察・実験・ログ取得などで自分たちが目的に合わせて直接収集したデータです。二次データとの違い、使う場面、DS検定で迷いやすい判断軸を整理します。定義、具体例、似た概念との違い、選択肢の見分け方を整理します。主要な混同パターンや実務での読み取り方も確認します。"
