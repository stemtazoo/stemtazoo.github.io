---
layout: page
title: 一次データとは？アンケート・実験・自社ログの具体例【DS検定】
description: "一次データとは、調査目的に合わせて自分たちが直接収集するデータです。アンケート、インタビュー、実験、センサー計測、自社ログなどの具体例と、収集設計・品質管理で注意するポイントをDS検定向けに整理します。"
...
一次データと二次データを具体例で見分けたい場合は、[一次データと二次データの違い｜政府統計・アンケートはどっち？](/ds/primary-secondary-data/)で比較しています。
...
Webから取得したという理由だけでは一次データとはいえません。判断には、誰が何の目的で元データを収集したかを見る必要があります。

政府統計、スクレイピング、自社ログなどの迷いやすい例は、[一次データと二次データの違い](/ds/primary-secondary-data/)で詳しく整理しています。
