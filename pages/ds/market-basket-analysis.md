...
description: "マーケットバスケット分析は、購買履歴から一緒に買われやすい商品の組合せを見つける分析手法です。アソシエーション分析、支持度、信頼度、リフト値、Aprioriアルゴリズムとの関係をDS検定向けに整理します。 データ分析での使いどころ、関連する指標・手法との違い、DS検定で迷いやすい判断軸を確認できます。"
