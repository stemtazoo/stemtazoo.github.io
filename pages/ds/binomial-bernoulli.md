...
description: "二項分布を「成功・失敗のベルヌーイ試行をn回繰り返したときの成功回数の確率」として整理します。問題文の「n回中x回成功」から分布を見抜くDS検定の判断軸を確認します。"
...
このページでは、二項分布を「ベルヌーイ試行を何回も繰り返したときの成功回数」として整理します。1回の試行そのものを説明するページとは役割を分けます。

DS検定では、👉「n回中x回成功」という形が出たら二項分布、と判断できるかが問われます。
