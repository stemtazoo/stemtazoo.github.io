...
description: "CAP定理とは、分散システムでは「一貫性（Consistency）」「可用性（Availability）」「分断耐性（Partition tolerance）」の3つを同時に完全には満たせないという原則です。DS検定で問われる定義、具体例、似た概念との違い、選択肢の見分け方を整理します。"
